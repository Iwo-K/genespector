...
def make_layout(graphdata, main_title, subtitle):
    ...
    layout = html.Div(
        [
            html.H4(children=main_title, style={"textAlign": "center"}),
            html.H6(children=subtitle, style={"textAlign": "center"}),
            html.Div(
                [
                    html.Div(
                        [
                    ...
                    html.Div(
                        [
                            ...
                            dcc.Dropdown(
                                ...
                                options=[
                                    {"label": x, "value": x}
                                    for x in graphdata["catinfo"].columns.values
                                ],
                            ...
                            dcc.Dropdown(
                                ...
                                options=[
                                    {"label": x, "value": x}
                                    for x in graphdata["coords"].columns.values
                                ],
                            ...
                            dcc.Input(id="cmin_input", type="text", value=""),
                            dcc.Input(id="cmax_input", type="text", value=""),
                            ...
                            html.Br(),
                            html.Label(
                                children="Genespector by: Iwo Kucinski, Gottgens lab",
                                style={"textAlign": "left", "color": "#CCCCCC"},
                            ),
                            html.Label(
                                children="Code: https://github.com/Iwo-K/genespector",
                                style={"textAlign": "left", "color": "#CCCCCC"},
                            ),
                            html.Label(
                                children="Based on Dash/Plotly framework (https://plot.ly/products/dash/)",
                                style={"textAlign": "left", "color": "#CCCCCC"},
                            ),
                        ],
                        style={
